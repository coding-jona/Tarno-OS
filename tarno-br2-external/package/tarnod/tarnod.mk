...
# tarnod/Cargo.toml enthält nur noch [tarnod, tarnoctl, tarnod-protocol]
# als Workspace-Member (die frühere GUI-Crate tarnod-ui wurde entfernt) —
# ein plain `cargo build` baut also genau diese drei.
